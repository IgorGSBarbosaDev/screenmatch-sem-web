...
public class Principal {
    ...
    public void exibeMenu(){
        ...
        for (int i = 0; i < dados.totalTemporadas(); i++) {
         ...
         //implementação usando lambda para percorrer temporadas e episódios de forma mais concisa
        temporadas.forEach(t -> t.episodios().forEach(e -> System.out.println(e.titulo())));

//    List<String> nomes = Arrays.asList("Jacque", "Lucas", "Arthur", "Paulo", "Rodrigo");
//    nomes.stream()
//            .sorted()
...
//        System.out.println("Top 10 episodios mais bem avaliados: ");
